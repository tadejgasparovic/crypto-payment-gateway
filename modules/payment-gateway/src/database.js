...
module.exports = (suffix = '') => callback => {
	...
	mongoose.connect(`mongodb://${config.dbHost || '127.0.0.1'}:${config.dbPort || 27017}/payment-gateway${suffix}`, { useNewUrlParser: true, useCreateIndex: true, useFindAndModify: false }, () => {
